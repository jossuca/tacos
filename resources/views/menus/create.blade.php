...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">Registrar Menu</div>

                <div class="card-body">
                    <form method="POST" action="{{ route('menu.store.path')}}" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="" type="number" class="form-control" name="sale" value="{{ old('descripcion') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="" type=text class="form-control" name="description" value="{{ old('descripcion') }}">
